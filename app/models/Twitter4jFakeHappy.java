 ...
 *
 */
public class Twitter4jFakeHappy implements Twitter,TwitterApiInstance{

	private static Twitter4jFakeHappy twitter4jFakeHappy;
	@Override
	public Twitter geTwitterInstance() {
		if(twitter4jFakeHappy==null) {
			twitter4jFakeHappy = new Twitter4jFakeHappy();
		}
		return twitter4jFakeHappy;
	}
	@Override
